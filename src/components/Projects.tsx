        ...
        {featuredProjects.map((project, i) => (
          ...
          >
            ...
            >
              ...
              >
                {project.githubUrl && (
                  <a href={project.githubUrl} className="hover:text-accent transition-colors p-2 -m-2" aria-label="GitHub Link">
                ...
                {project.liveUrl && (
                  <a href={project.liveUrl} className="hover:text-accent transition-colors p-2 -m-2" aria-label="External Link">
