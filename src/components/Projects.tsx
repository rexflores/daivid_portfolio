      ...
      <div className="flex flex-col gap-12 md:gap-[100px]">
        {featuredProjects.map((project, i) => (
          ...
          >
            ...
            <div className={`relative w-full h-[250px] md:h-full md:min-h-[300px] rounded border border-border-primary overflow-hidden shadow-lg bg-bg-secondary group
              ...
              >
                {project.githubUrl && (
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      onClick={() => setActiveRepo(project.githubUrl.replace('https://github.com/', ''))}
                      className="flex items-center gap-2 px-3 py-1.5 bg-bg-secondary hover:bg-border-primary border border-border-primary hover:border-accent transition-all rounded-md text-xs font-mono text-text-secondary hover:text-accent shadow-sm"
                    >
                      <Code className="w-3.5 h-3.5" /> Live Repo
                    </button>
                  </div>
                )}
                {project.liveUrl && (
